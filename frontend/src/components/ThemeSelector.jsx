        ...
        <div className='space-y-1'>
            {THEMES.map((themeOption) =>(
                <button
                    ...
                    className={`w-full px-4 py-3 rounded-xl flex items-center gap-3 transition-colors ${theme === themeOption.none ? "bg-primary/10 text-primary" : "hover:bg-base-content/5"}`}
