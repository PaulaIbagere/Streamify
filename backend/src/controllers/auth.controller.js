...
export async function signup(req, res){
    ...
    try{
        ...
        const idx = Math.floor(Math.random() * 100) + 1 //generate a num from 1-100
        ...
        res.cookie("jwt", token, {
            ...
            httpOnly: true, //pervent XSS attacks
            sameSite: "Strict", //pervent CSRF attacks
...
export async function login(req, res){
    try{
        ...
        console.log("Error in login controller", user)
    }
